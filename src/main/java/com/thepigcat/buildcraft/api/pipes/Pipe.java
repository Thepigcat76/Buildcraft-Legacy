...
public record Pipe(boolean disabled, float transferSpeed, boolean extracting, ResourceLocation texture) {
    public static final Codec<Pipe> CODEC = RecordCodecBuilder.create(inst -> inst.group(
            ...
            Codec.BOOL.fieldOf("extracting").forGetter(Pipe::extracting),
